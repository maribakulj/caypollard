...
| `03_kg_embeddings.ipynb` | planned | graph baselines |
| `04_visual_retrieval_baseline.ipynb` | planned | visual-only benchmark |
| `05_graph_retrieval_baseline.ipynb` | planned | graph-only benchmark |
